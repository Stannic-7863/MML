...
when ODIN_OS == .Windows {
	...
	foreign import lib {"windows/nativefiledialog.lib", "system:Winmm.lib", "system:kernel32.lib", "system:Ole32.lib", "system:Shell32.lib"}
} else when ODIN_OS == .Linux {
	foreign import lib {"linux/libnativefiledialog.a", "system:dbus-1", "system:dl", "system:pthread"}
}
